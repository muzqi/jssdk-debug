...
},{"./helpers/error-msgs":"../src/helpers/error-msgs.js","./helpers/tools":"../src/helpers/tools.js"}],"../src/scripts/webview.js":[function(require,module,exports) {
"use strict";
...
doc.getElementById("button-navigate-back").onclick = function () {
  _jssdk.default.navigateBack();
};

doc.getElementById("button-switch-tab").onclick = function () {
  var v = doc.getElementById("input-switch-tab").value;

  _jssdk.default.switchTab(_objectSpread({
    index: v
  }, asyncParameters));
};

doc.getElementById("button-show-navigation-bar-loading").onclick = function () {
  _jssdk.default.showNavigationBarLoading(_objectSpread({}, asyncParameters));
};

doc.getElementById("button-hide-navigation-bar-loading").onclick = function () {
  _jssdk.default.hideNavigationBarLoading(_objectSpread({}, asyncParameters));
};

doc.getElementById("button-set-navigation-bar-title").onclick = function () {
  var v = doc.getElementById("input-set-navigation-bar-title").value;

  _jssdk.default.setNavigationBarTitle(_objectSpread({
    title: v
  }, asyncParameters));
};

doc.getElementById("button-set-navigation-bar-color").onclick = function () {
  var theme = doc.getElementById("select-set-navigation-bar-color").value;
  var frontColor = doc.getElementById("input-set-navigation-bar-color").value;

  _jssdk.default.setNavigationBarColor(_objectSpread({
    theme: theme,
    frontColor: "#".concat(frontColor)
  }, asyncParameters));
};
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../src/scripts/webview.js"], null)
//# sourceMappingURL=/webview.ffaccb38.js.map